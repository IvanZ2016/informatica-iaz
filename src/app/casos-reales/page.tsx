        ...
        <div className="min-h-screen bg-background py-20 px-4 md:px-8">
            ...
            <div className="max-w-4xl mx-auto">
                ...
                <section className="flex justify-center">
                    <div className="w-full max-w-2xl bg-white/5 border border-white/10 rounded-2xl shadow-2xl p-8 md:p-12 relative overflow-hidden group hover:border-primary/50 transition-all duration-500 animate-in fade-in slide-in-from-bottom-8 duration-1000 delay-200">
                        ...
                        <div className="flex flex-col items-center text-center">
                            ...
                            <Link
                                ...
                                target="_blank"
                                className="inline-flex items-center gap-2 bg-primary hover:bg-primary/90 text-white font-bold py-4 px-8 rounded-full transition-all duration-300 transform hover:scale-105 shadow-lg shadow-primary/30"
                            >
